            ...
            new RetrofitFactory(Api.JISU_URL).getApiInterface()
                    ...
                    .subscribe(new Observer<Weather>() {
                        ...
                        public void onNext(Weather weather) {
                            ...
                            FileUtil.saveFile(jsonStr, Constants.SAVE_WEATHER_NAME);
                            ...
                            SPUtils.putData(Constants.DEFAULT_CITY_TEMP, temp);
                            SPUtils.putData(Constants.DEFAULT_CITY_IMG, img);
                            SPUtils.putData(Constants.WEATHER_COLOR, color);
                            SPUtils.putData(Constants.DEFAULT_CITY_QUALITY, weather.getInfo().getAqi().getQuality());
                            SPUtils.putData(Constants.DEFAULT_CITY_LOW_TEMP, weather.getInfo().getTempLow());
                            SPUtils.putData(Constants.DEFAULT_CITY_HIGH_TEMP, weather.getInfo().getTempHigh());
                            listener.loadSuccess(weather);
                        }
